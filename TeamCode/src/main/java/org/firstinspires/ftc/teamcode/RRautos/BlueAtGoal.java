...
@Autonomous(name = "Blue At Goal", group = "RoadRunnerAuto")
public class BlueAtGoal extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()){
            Pose2d pose = new Pose2d(14.08, 62.61, Math.toRadians(-90.00)); //Switch
